            ...
            <form id="validateForm" action="">
                ...
                <div class="form-item-table mt-22">
                    <table cellpadding="0" cellspacing="0" width="100%">
                        <tr>
                            <td class="form-tab-label wid-198 "><label class="form-label"><i class="form-require">*</i>餐饮名称:</label></td>
                            <td>
                        ...
                        <tr>
                            ...
                            <td>
                                <div class="form-table-edit">
                                    <div class="daq-inp-rule wid-358">
                                        <input type="text" name="license" class="s_input s_input_fb w281" validate="{maxlength:100}" value="${dto.license!}"/>
                                    </div>
                                </div>
                            </td>
                        </tr>
                        ...
                        <tr>
                            <td class="form-tab-label"><label class="form-label">餐饮等级:</label></td>
                            <td>
                                <div class="form-table-edit">
                                    <div id="restaurantLevel" class="daq-select wid-198 fl mr-20">
                                        <select name="restaurantLevel">
                                            <#if restaurantLevel??>
                                                <#list restaurantLevel as t>
                                                    <option value="${t.value!}" <#if t.value == (dto.scenicType)!'restaurantLevel_1'>selected</#if>>${t.name!}</option>
                                                </#list>
                                            </#if>
                                        </select>
                                    </div>
                        ...
                        <tr>
                            <td class="form-tab-label"><label class="form-label">餐饮类型:</label></td>
                            <td>
                                <div class="form-table-edit">
                                    <div id="restaurantType" class="daq-select wid-198 fl mr-20">
                                        <select name="restaurantType">
                                            <#if restaurantType??>
                                                <#list restaurantType as t>
                                                    <option value="${t.value!}" <#if t.value == (dto.scenicType)!'restaurantType_1'>selected</#if>>${t.name!}</option>
                                                </#list>
                                            </#if>
                                        </select>
                                    </div>
                        ...
                        <tr>
                            <td class="form-tab-label"><label class="form-label">所获荣誉说明:</label></td>
                            <td>
                                <div class="form-table-edit">
                                    <div class="daq-inp-rule wid-158 fl">
                        ...
                        <tr>
                            <td class="form-tab-label"><label class="form-label">餐饮风格:</label></td>
                            <td>
                                <div class="form-table-edit">
                                    <div class="daq-inp-rule wid-158 fl">
                                        <input type="text" name="diningStyle" validate="{maxlength:200}" class="s_input w120 fom_inp" value="${dto.diningStyle!}"/>
                                    </div>
                                </div>
                            </td>
                        </tr>
                        <tr>
                            <td class="form-tab-label"><label class="form-label">所属菜系:</label></td>
                            <td>
                                <div class="form-table-edit">
                                    <div class="daq-inp-rule wid-158 fl">
                                        <input type="text" name="styleCooking" validate="{maxlength:200}" class="s_input w120 fom_inp" value="${dto.styleCooking!}" />
                                    </div>
                                </div>
                            </td>
                        </tr>
                        <tr>
                            <td class="form-tab-label"><label class="form-label">特色菜:</label></td>
                            <td>
                                <div class="form-table-edit">
                                    <div class="daq-inp-rule wid-158 fl">
                                        <input type="text" name="specialtyDish" validate="{maxlength:200}" class="s_input w120 fom_inp" value="${dto.specialtyDish!}" />
                                    </div>
                                </div>
                            </td>
                        </tr>
                        ...
                        <tr>
                            <td class="form-tab-label"><label class="form-label"><i class="form-require">*</i>传真电话:</label></td>
                            <td>
                                <div class="form-table-edit">
                                    <div class="daq-inp-rule wid-158 fl">
                                        <input type="text" name="fax" validate="{required:true,phone:true}" class="s_input w120 fom_inp" value="${dto.fax!}"/>
                                    </div>
                                </div>
                            </td>
                        </tr>
                        ...
                        <tr>
                            <td class="form-tab-label"><label class="form-label">可容纳就餐人数:</label></td>
                            <td>
                                <div class="form-table-edit">
                                    <div class="daq-inp-rule wid-158 fl">
                                        <input type="text" name="diningNumber" validate="{digits: true,range:[0,99999],messages:{digits: '请输入非负整数'}}" class="s_input w120 fom_inp" value="${dto.diningNumber!}"/>
                                    </div>
                                </div>
                            </td>
                        </tr>
                        <tr>
                            <td class="form-tab-label"><label class="form-label">包间数量:</label></td>
                            <td>
                                <div class="form-table-edit">
                                    <div class="daq-inp-rule wid-158 fl">
                                        <input type="text" name="rooms" validate="{digits: true,range:[0,9999],messages:{digits: '请输入非负整数'}}" class="s_input w120 fom_inp" value="${dto.rooms!}"/>
                                    </div>
                                </div>
                            </td>
                        </tr>
                        ...
                        <tr>
                            ...
                            <td>
                                <div class="form-table-edit">
                                    <div class="daq-inp-rule wid-158 fl">
                                        <input type="text" name="email" validate="{maxlength:50}" class="s_input w120 fom_inp" value="${dto.email!}" />
                                    </div>
                                </div>
                            </td>
                        </tr>
                        ...
                        <tr>
                            ...
                            <td>
                                <div class="form-table-edit">
                                    <div class="daq-inp-rule wid-158 fl">
                                        <input type="text" name="legalPhone" validate="{number:true,phone:true}" class="s_input w120 fom_inp" value="${dto.legalPhone!}" />
                                    </div>
                                </div>
                            </td>
                        </tr>
                        ...
                        <tr>
                            ...
                            <td>
                                <div class="form-table-edit">
                                    <div class="daq-inp-rule wid-158 fl">
                                        <input type="text" name="presidePhone" validate="{number:true,phone:true}" class="s_input w120 fom_inp" value="${dto.presidePhone!}" />
                                    </div>
                                </div>
                            </td>
                        </tr>
                        <tr>
                            ...
                            <td>
                                <div class="form-table-edit">
                                    <div class="daq-inp-rule wid-358">
                                        <input type="text" readonly="readonly" name="registerDate" id="registerDate" class="s_input s_input_fb w281 js_tooltip"  skin="dark" data-tips="请选择时间" position="bottom-left" />
                                    </div>
                                </div>
                            </td>
                        </tr>
...
<script type="application/javascript">
    $("#restaurantLevel").daqSelect({
        value: '${dto.restaurantLevel!'restaurantLevel_1'}',
        callback: function (data) {
        }
    });
    $("#restaurantType").daqSelect({
        value: '${dto.restaurantType!'restaurantType_1'}',
        callback: function (data) {
        }
    });
    $("#status").daqRadio();
