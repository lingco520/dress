        ...
        <div class="section-son-content source-pad">
            <div class="filter-condition clearfix mt-32">
                ...
                <div class="form-item fl mr-20">
                    <label class="form-label">乡村旅游名称：</label>
                    <div class="daq-inp-rule wid-120 fl">
                        <input type="text" value="" name="name" placeholder="乡村旅游名称"/>
                    </div>
                </div>
                <div class="form-item fl mr-20">
                    <label class="form-label">乡村旅游类型：</label>
                    <div id="type" class="daq-select wid-150 fl">
                        <select name="type">
                ...
                <div class="form-item fl mr-20">
                    <label class="form-label">乡村旅游等级：</label>
                    <div id="level" class="daq-select wid-150 fl">
                        <select name="level">
                            <option value="">全部</option>
