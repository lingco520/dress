            ...
            <form id="validateForm" action="">
                ...
                <div class="form-item-table mt-22">
                    <table cellpadding="0" cellspacing="0" width="100%">
                        <tr>
                            <td class="form-tab-label wid-198 "><label class="form-label"><i class="form-require">*</i>加油站名称:</label></td>
                            <td>
                        ...
                        <#include "../baidu_map.ftl"/>
                        <tr>
                            <td class="form-tab-label"><label class="form-label"><i class="form-require">*</i>地址:</label></td>
                            <td>
                                <div class="form-table-edit">
                                    <div class="daq-inp-rule wid-358 fl">
                                        <input type="text" name="address" id="address" class="s_input s_input_fb w318" validate="{required:true,minlength:2,maxlength:100}" value="${dto.address!}"/>
                                    </div>
                                </div>
                            </td>
                        </tr>
