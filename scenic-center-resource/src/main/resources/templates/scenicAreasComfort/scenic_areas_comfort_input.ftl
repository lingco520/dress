            ...
            <form id="validateForm" action="">
                ...
                <div class="form-item-table mt-22">
                    <table cellpadding="0" cellspacing="0" width="100%">
                        <tr>
                            <td class="form-tab-label"><label class="form-label"><i class="form-require">*</i>景区名称:</label></td>
                            <td>
                                <div class="form-table-edit">
                                    <div class="daq-inp-rule wid-158">
                                        <input type="text" name="name" validate="{required:true}" class="s_input w120 fom_inp" value="${dto.name!}"/>
                                    </div>
                                </div>
                            </td>
                        </tr>
