(function(t, i, s, e) {
    ...
    l.prototype = {
        ...
        render: function() {
            var t = '<div class="ui-slider-wrap">' + '<div class="ui-slider-text ui-slider-no-select">' + this.opts.textMsg + "</div>" + '<div class="ui-slider-btn init ui-slider-no-select sysfont">&#xe624;</div>' + '<div class="ui-slider-bg"></div>' + "</div>";
            this.ele.html(t);
            this.initStatus()
        },
        initStatus: function() {
        ...
        restore: function() {
            ...
            this.result = false;
            this.initStatus();
            this.sliderBtn.removeClass("success").html("&#xe624;").animate({
                left: 0
            },
            i);
        ...
        sliderMouseup: function() {
            ...
            function() {
                if (i.sliderBtn_left != i.maxLeft) {
                    ...
                    i.ele.find(".ui-slider-btn").addClass("success").html("&#xe628;");
                    i.result = true
                }
                i.sliderBtn.animate({
