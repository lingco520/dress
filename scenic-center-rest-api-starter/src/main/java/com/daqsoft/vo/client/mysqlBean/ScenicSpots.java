...
public class ScenicSpots implements Serializable {
    ...
    private  String  scenicOrganization;
    private  String  administrativeAgencyAddress;
    private  String  advisoryTelephone;
    private  String  CustomerserviceFax;
    private  String  websiteUrl;
    private  String  wapUrl;
    private  String  officialPublicSpace;
    private  String  email;
    private  String  characteristicLandscape;
    private  String  scenicTourismProject;
    private  String  supportingServiceFacilities;
    private  String  permanentTourismActivities;
    private  String  touristServiceCenter;
    private  String  electronicGuide;
    private  String  recommendedTourRoute;
    private  String  ScenicTourTips;
    ...
    public void setWantgo(int wantgo) {
        this.wantgo = wantgo;
    }
